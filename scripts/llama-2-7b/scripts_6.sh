...
--fp8_hi_align_start 0 --fp8_hi_align_exp_field 2 --fp8_tail_pad_bits -1 --output_file cuda6.json
# FP8-E2M5 double近似，5bit尾数
CUDA_VISIBLE_DEVICES=6 python Iron_weight_only_quant/main.py --model_path /home/data/meta-llama/llama2-7b/ --w_format fp8 --w_bits 8 --fp8_exp_bits 2 --fp8_mantissa_bits 5 --w_group_size 64 --w_symmetric --approximate --quant_dim 1 --eval_mode ppl --datasets wikitext ptb c4 \
--fp8_hi_align_start 0 --fp8_hi_align_exp_field 2 --fp8_tail_pad_bits -1 --double_approximate --output_file cuda6.json
...
# --fp6_hi_align_start 0 --fp6_hi_align_exp_field 2 --fp6_tail_pad_bits 1 --output_file cuda6.json
# # 12.10 ours(FP6E2M3到4bit尾数，double近似）
# CUDA_VISIBLE_DEVICES=6 python Iron_weight_only_quant/main.py --model_path /home/data/meta-llama/llama2-7b/ --w_format fp6 --w_bits 6 --fp6_exp_bits 2 --fp6_mantissa_bits 3 --w_group_size 64 --w_symmetric --approximate --quant_dim 1 --eval_mode ppl --datasets wikitext ptb c4 \
# --fp6_hi_align_start 0 --fp6_hi_align_exp_field 2 --fp6_tail_pad_bits 1 --double_approximate --output_file cuda6.json
# # 12.11 ours(FP6E3M2到5bit尾数，分离outlier)
# CUDA_VISIBLE_DEVICES=6 python Iron_weight_only_quant/main.py --model_path /home/data/meta-llama/llama2-7b/ --w_format fp6 --w_bits 6 --fp6_exp_bits 3 --fp6_mantissa_bits 2 --w_group_size 64 --w_symmetric --approximate --quant_dim 1 --eval_mode ppl --datasets wikitext ptb c4 \
# --fp6_hi_align_start 4 --fp6_hi_align_exp_field 6 --fp6_tail_pad_bits 2 --output_file cuda6.json
# # 12.12 ours(FP6E3M2到4bit尾数，double近似）
# CUDA_VISIBLE_DEVICES=6 python Iron_weight_only_quant/main.py --model_path /home/data/meta-llama/llama2-7b/ --w_format fp6 --w_bits 6 --fp6_exp_bits 3 --fp6_mantissa_bits 2 --w_group_size 64 --w_symmetric --approximate --quant_dim 1 --eval_mode ppl --datasets wikitext ptb c4 \
# --fp6_hi_align_start 4 --fp6_hi_align_exp_field 6 --fp6_tail_pad_bits 2 --double_approximate --output_file cuda6.json